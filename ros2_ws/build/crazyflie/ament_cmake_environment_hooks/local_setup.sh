...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/install/crazyflie"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crazyflie/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crazyflie/environment/path.sh"
