...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/install/ros_gz_crazyflie_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros_gz_crazyflie_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros_gz_crazyflie_gazebo/environment/path.sh"
